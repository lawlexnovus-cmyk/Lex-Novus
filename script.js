...
const translations = {
    'nl': {
        ...
        'whySubtitle': 'Wij zijn gebaseerd op de principes van toegankelijkheid, expertise en toewijding aan de bescherming van uw rechten in het sociaal bestuursrecht.',
        ...
        'why2Body': 'We blijven op de hoogte van wetswijzigingen om het meest actuele en effectieve advies te bieden in sociale verzekeringen en belastingrecht.',
        ...
        'service1Desc': 'Juridische begeleiding bij werknemersverzekeringen, werkloosheid en langdurige arbeidsongeschiktheid, inclusief bezwaar tegen uitkeringsbesluiten.',
        'service2': 'Fiscaal Recht voor Expats & Particulieren',
        'service2Desc': 'Adviesdiensten voor de inkomstenbelasting van particulieren, inclusief jaarlijkse aangiften en fiscale naleving voor internationale bewoners.',
        'service3': 'Sociale Bijstand & Publieke Hulp',
        'service3Desc': 'Juridische ondersteuning bij bijstandszaken en vertegenwoordiging bij geschillen met de gemeentelijke sociale dienst.',
        'service4': 'Bestuursrechtelijke Beroepen',
        'service4Desc': 'Het aanvechten van beslissingen van overheidsinstanties via officiële bezwaar- en beroepsprocedures.',
        'formTitle': 'Start Uw Consultatie',
        'formSubtitle': 'Vul het formulier in voor hulp bij uw juridische of fiscale zaak. Wij reageren binnen 3 werkdagen.',
    ...
    'en': {
        ...
        'whySubtitle': 'We specialize in Dutch administrative law with a focus on comprehensive social security protection.',
        ...
        'why2Body': 'Deep knowledge of Dutch social insurance systems and private tax law for international residents.',
        'why3Title': 'Clear Communication',
        'why3Body': 'We translate complex Dutch legal procedures into clear English guidance.',
        ...
        'service1Desc': 'Legal guidance on employee benefits, unemployment, and long-term disability claims, including appeals against benefit decisions.',
        'service2': 'Expat & Individual Tax Law',
        'service2Desc': 'Advisory services for personal income tax, including annual filings and fiscal compliance for international residents.',
        'service3': 'Social Assistance & Public Aid',
        'service3Desc': 'Legal support for welfare benefit matters and representation in disputes with municipal social services.',
        'service4': 'Administrative Law Appeals',
        'service4Desc': 'Challenging decisions made by government authorities through official objection and appeal procedures.',
        'formTitle': 'Initiate Your Consultation',
        'formSubtitle': 'Fill out the form below for help with your legal or tax case. We respond within 3 business days.',
        'formName': 'Full Name',
        ...
        'formDescPlaceholder': 'Describe your issue, including relevant authorities and deadlines.',
    ...
    'fa': {
        ...
        'heroBody': 'کمک‌های حقوقی تخصصی برای قوانین تأمین اجتماعی هلند، ادعاهای ازکارافتادگی و مزایای رفاهی. ما همچنین مشاوره مالیاتی جامع و نمایندگی در اختلافات اداری ارائه می‌دهیم.',
        'heroButton': 'دریافت مشاوره حقوقی',
        'heroSocialButton': 'لینک‌های اجتماعی ما',
        'whyTitle': 'چرا ما را انتخاب کنید؟',
        'whySubtitle': 'ما در حقوق اداری هلند با تمرکز بر حمایت جامع در امور تأمین اجتماعی تخصص داریم.',
        'why1Title': 'متخصصان حقوق اداری',
        'why1Body': 'تضمین بهترین نتیجه ممکن در پرونده شما علیه تصمیمات دولتی یا شهرداری.',
        'why2Title': 'تخصص و بینش',
        'why2Body': 'دانش عمیق از سیستم‌های بیمه اجتماعی و حقوق مالیاتی هلند برای ساکنان بین‌المللی.',
        'why3Title': 'ارتباط شفاف',
        'why3Body': 'ما رویه‌های پیچیده حقوقی هلند را برای شما به بیانی روشن ترجمه می‌کنیم.',
        'servicesTitle': 'زمینه های تخصص',
        'servicesSubtitle': 'راهنمایی تخصصی در حقوق تأمین اجتماعی، مالیات و اداری در هلند.',
        'service1': 'حقوق تأمین اجتماعی و ازکارافتادگی',
        'service1Desc': 'راهنمایی حقوقی در زمینه مزایای کارکنان، بیکاری و ادعاهای ازکارافتادگی بلندمدت، از جمله اعتراض به تصمیمات مربوط به مزایا.',
        'service2': 'حقوق مالیاتی افراد و مهاجران (اکسپت‌ها)',
        'service2Desc': 'خدمات مشاوره‌ای برای مالیات بر درآمد شخصی، از جمله تشکیل پرونده‌های سالانه و رعایت مقررات مالیاتی برای ساکنان بین‌المللی.',
        'service3': 'کمک‌های اجتماعی و رفاه عمومی',
        'service3Desc': 'پشتیبانی حقوقی برای مسائل مربوط به مزایای رفاهی و نمایندگی در اختلافات با خدمات اجتماعی شهرداری.',
        'service4': 'درخواست‌های تجدیدنظر اداری',
        'service4Desc': 'به چالش کشیدن تصمیمات اتخاذ شده توسط مقامات دولتی از طریق رویه‌های رسمی اعتراض و تجدیدنظر.',
        'formTitle': 'شروع مشاوره',
        'formSubtitle': 'فرم زیر را برای کمک در پرونده حقوقی یا مالیاتی خود پر کنید. ما طی 3 روز کاری پاسخ می‌دهیم.',
        'formName': 'نام کامل',
        ...
        'formDescPlaceholder': 'مسئله خود را، از جمله مراجع مربوطه و ضرب‌الاجل‌ها، توصیف کنید.',
        'formSubmit': 'ارسال درخواست',
        'formNote': 'اطلاعات شما به صورت امن ارسال می‌شود. به زودی با شما تماس خواهیم گرفت.',
    ...
    'ar': {
        ...
        'heroBody': 'مساعدة قانونية متخصصة في قوانين الضمان الاجتماعي الهولندي، ومطالبات الإعاقة، ومزايا الرعاية الاجتماعية. كما نقدم استشارات ضريبية شاملة وتمثيلًا في النزاعات الإدارية.',
        'heroButton': 'اطلب استشارة قانونية',
        'heroSocialButton': 'روابطنا الاجتماعية',
        'whyTitle': 'لماذا تختارنا؟',
        'whySubtitle': 'نحن متخصصون في القانون الإداري الهولندي مع التركيز على الحماية الشاملة للضمان الاجتماعي.',
        'why1Title': 'خبراء في القانون الإداري',
        'why1Body': 'تأمين أفضل نتيجة لقضيتك ضد قرارات الحكومة أو البلدية.',
        'why2Title': 'الخبرة والبصيرة',
        'why2Body': 'معرفة عميقة بنظم التأمين الاجتماعي الهولندي وقانون الضرائب الخاص للمقيمين الدوليين.',
        'why3Title': 'تواصل واضح',
        'why3Body': 'نحن نترجم الإجراءات القانونية الهولندية المعقدة إلى إرشادات واضحة وسهلة الفهم.',
        'servicesTitle': 'مجالات الخبرة',
        'servicesSubtitle': 'إرشادات متخصصة في قوانين الضمان الاجتماعي والضرائب والقانون الإداري في هولندا.',
        'service1': 'قانون الضمان الاجتماعي والإعاقة',
        'service1Desc': 'إرشادات قانونية بشأن مزايا الموظفين والبطالة ومطالبات الإعاقة طويلة الأجل، بما في ذلك الطعون ضد قرارات المزايا.',
        'service2': 'قانون الضرائب للأفراد والمغتربين',
        'service2Desc': 'خدمات استشارية لضريبة الدخل الشخصي، بما في ذلك الإقرارات السنوية والامتثال المالي للمقيمين الدوليين.',
        'service3': 'المساعدة الاجتماعية والإعانات العامة',
        'service3Desc': 'دعم قانوني لمسائل مزايا الرعاية الاجتماعية والتمثيل في النزاعات مع الخدمات الاجتماعية للبلدية.',
        'service4': 'الطعون في القانون الإداري',
        'service4Desc': 'الطعن في القرارات الصادرة عن السلطات الحكومية من خلال إجراءات الاعتراض والاستئناف الرسمية.',
        'formTitle': 'ابدأ استشارتك',
        'formSubtitle': 'يرجى ملء النموذج أدناه للحصول على مساعدة في قضيتك القانونية أو الضريبية. نرد خلال 3 أيام عمل.',
